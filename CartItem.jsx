...
const CartItem = ({ onContinueShopping }) => {
  ...
  // Helper function to turn "$15" into the number 15
  ...
  // 3. Decrement quantity (removes item if quantity reaches 0)
  ...
  // 5. Calculate total cost based on quantity for an individual item
